...
<div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700" style="display: flex; flex-direction: column; width: 20%;">
    ...
    <div class="p-5">
        ...
        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400"><b>Release date: </b>{{ $movie['release_date'] }}</p>
        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400"><b>Vote: </b>{{ $movie['vote_average'] }}</p>
        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400"><b>Description: </b>{{ str_limit($movie['overview'], 150) }}</p>
