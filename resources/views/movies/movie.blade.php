        ...
        <div>
            <div class="relative z-40 lg:hidden" role="dialog" aria-modal="true">
                ...
                <div class="fixed inset-0 z-40 flex">
                    <div
                        class="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-gray-800 py-4 pb-12 shadow-xl">
                        <div class="flex items-center justify-between px-4">
                            <h2 class="text-lg font-medium text-gray-900">Filters</h2>
                            <button type="button"
                                class="-mr-2 flex h-10 w-10 items-center justify-center rounded-md bg-gray-800 p-2 text-gray-400">
                        ...
                        <form class="mt-4 border-t border-gray-200">
                            ...
                            <ul role="list" class="px-2 py-3 font-medium text-gray-400">
                                <li>
                            ...
                            <div class="border-t border-gray-200 px-4 py-6">
                                <h3 class="-mx-2 -my-3 flow-root">
                                    ...
                                    <button type="button"
                                        class="flex w-full items-center justify-between bg-gray-800 px-2 py-3 text-gray-400 hover:text-gray-500"
                ...
                <div class="flex items-baseline justify-between border-b border-gray-200 pt-24 pb-6">
                    ...
                    <div class="flex items-center">
                        <div class="relative inline-block text-left">
                            ...
                            <div class="absolute right-0 z-10 mt-2 w-40 origin-top-right rounded-md bg-gray-800 shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none"
                        ...
                        <form class="hidden lg:block">
                            ...
                            <div class="border-b border-gray-200 py-6">
                                <h3 class="-my-3 flow-root">
                                    <!-- Expand/collapse section button -->
                                    <button type="button"
                                        class="flex w-full items-center justify-between bg-gray-800 py-3 text-sm text-gray-400 hover:text-gray-500"
