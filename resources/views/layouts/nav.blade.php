                ...
                @guest
                    <div>
                        <button type="submit"
                            ...
                            <a href="/login">{{ __('message.sign_in') }}</a>
                        </button>
                    </div>
                @endguest
                @auth
                        ...
                        <div class="relative ml-3">
                            ...
                            <div class="dropdown-nav absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                                ...
                                <a href="{{ route('settings') }}" class="block px-4 py-2 text-sm text-gray-700"
                                    role="menuitem" tabindex="-1" id="user-menu-item-1">{{ __('message.settings') }}</a>
                                <a href="{{ route('logout') }}" class="block px-4 py-2 text-sm text-gray-700"
                                    role="menuitem" tabindex="-1" id="user-menu-item-2">{{ __('message.sign_out') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
